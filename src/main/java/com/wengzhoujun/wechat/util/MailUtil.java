...
public class MailUtil {
    ...
    private static String mailSenderAddress = "wengzhoujun@163.com";
    private static String mailSenderNick = "天气";
    private static String mailSenderUsername = "wengzhoujun@163.com";
    private static String mailSenderPassword = "wzj888";
